 ...
 */
public class reviewdataa extends javax.swing.JFrame {
    ...
    try{
        MongoClient mongoClient = new MongoClient("localhost",27017);
            ...
            String[] colNames = {"Name","Type","Rating","Comment"};
            DefaultTableModel model = new DefaultTableModel(colNames, 0);
            
            while(cursor.hasNext()){
                DBObject obj = cursor.next();
                String Name = (String) obj.get("Name");
                String Type1 = (String) obj.get("Reviewtype");
                String Rating = (String) obj.get("Rating");
                String Comment = (String) obj.get("Comment");
                model.addRow(new Object[]{ Name,Type1,Rating,Comment});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reviewdataa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
